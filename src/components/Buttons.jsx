    ...
    clsx(
      ...
      "select-none",
      {
        ...
        "h-8 px-2 bg-neutral-300/50 text-neutral-800 hover:text-neutral-900 hover:bg-neutral-300/75 focus:text-neutral-900 focus:bg-neutral-300/75":
          appearance === "toast",
        "bg-surfaceAlt/50 backdrop-blur text-uiText/80 ring-surfaceAlt2/10 hover:ring-surfaceAlt2/40 hover:text-uiText focus:ring-2 focus:ring-surfaceAlt2 focus:text-uiText hover:bg-surfaceAlt focus:bg-surfaceAlt":
          appearance === "overlay",
